// Leaf discovery. The ggml-op dispatch lives in the importer (src/import/Importer.cpp), and the
// arg-vs-constant split is the caller's, expressed through ExportOptions::runtime_args.
