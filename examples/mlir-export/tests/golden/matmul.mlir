module {
  func.func @forward(%arg0: tensor<32x32xf32> {txe.name = "input_0"}, %arg1: tensor<32x32xf32> {txe.name = "input_1"}) -> (tensor<32x32xf32> {txe.name = "res_0"}) attributes {llvm.emit_c_interface} {
